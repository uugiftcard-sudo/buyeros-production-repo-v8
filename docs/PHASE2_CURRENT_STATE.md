...
| --- | --- | --- | --- |
| Buyer AI 中樞 | `buyer_ai` | `/Users/rubykan/Downloads/buyeros-production-repo-v8` | BuyerOS, AI Team, Context Hub, Telegram, buyer report, refund reconciliation, OCR posting, manual review |
...
Boundary note: refund reconciliation and refund/OCR manual review belong to `buyer_ai`.
